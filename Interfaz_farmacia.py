...
def punto1():
    ...
    os.system('gnome-terminal -x python3 leerFichero_trayectoria.py 0')   #lanzamos el leerFichero
...
def punto2():
    ...
    os.system('gnome-terminal -x python3 leerFichero_trayectoria.py 1')   #lanzamos el leerFichero
...
def punto3():
    ...
    os.system('gnome-terminal -x python3 leerFichero_trayectoria.py 2')   #lanzamos el leerFichero
...
def punto4():
    ...
    os.system('gnome-terminal -x python3 leerFichero_trayectoria.py 3')   #lanzamos el leerFichero
...
def trayectoria1():
    ...
    os.system('gnome-terminal -x python3 leerFichero_trayectoria.py 0 1 2')   #lanzamos el leerFichero

#Botón trayectoria2 que se encarga de lanzar el script leerFichero pasandole como 
#argumentos por la línea de comandos los números de coordenadas correspondientes (0-1-2)
def trayectoria2():

    os.system('gnome-terminal -x python3 2 leerFicheroTrayectoria.py 1 2 0')   #lanzamos el leerFichero

#Botón trayectoria3 que se encarga de lanzar el script leerFichero pasandole como 
#argumentos por la línea de comandos los números de coordenadas correspondientes (0-1-2)
def trayectoria3():

    os.system('gnome-terminal -x python3 3 leerFicheroTRayectoria.py 2 1 0')   #lanzamos el leerFichero
...
window.geometry("900x900")      #le asignamos un tamaño a la ventana principal
window.resizable(1,1)           #le permitimos que se pueda redimensionar la ventana


#ADD IMAGE FILE; establecemos la imagen del mapa como fondo de la ventana
background= PhotoImage(file="house.pgm")
background_zoom=background.zoom(2)
labelImage= Label(window, image=background_zoom)
